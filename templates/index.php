													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td>
																...
																<div class="h3-2-center" style="color:#1e1e1e; font-family:Arial, sans-serif; min-width:auto !important; font-size:20px; line-height:26px; text-align:center; letter-spacing:5px">C\'EST TON</div>
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td>
																...
																<div class="h3-1-center" style="font-family: Arial; color:#1e1e1e; font-family:Georgia, serif; min-width:auto !important; font-size:20px; line-height:26px; text-align:center; white-space: pre-line;">Réserve ton week end du 12 mai, au programme :

etc.

Pour se restaurer, des buvettes seront mises à disposition, à un prix abordable. 

L\'expo sera aussi conviviale que l\'année dernière, et nous vous attendons encore plus nombreux compte tenu du succès de celle ci. N\'hésitez pas à partager et faire venir plus de monde, qu\'ils soient aficionados ou artistes.

pour vous désinscrire etc.</div>
																							...
																							<tr>
																								...
																								<td bgcolor="#d2973b">
																									<div class="text-btn" style="color:#ffffff; font-family:Arial, sans-serif; min-width:auto !important; font-size:16px; line-height:20px; text-align:center">
																										<a href="#" target="_blank" class="link-white" style="color:#ffffff; text-decoration:none"><span class="link-white" style="color:#ffffff; text-decoration:none">JE M\'INSCRIS</span></a>
																									</div>
																								</td>
								...
								<tr>
									...
									<td>
										...
										<div class="text-footer" style="color:#666666; font-family:Arial, sans-serif; min-width:auto !important; font-size:12px; line-height:18px; text-align:center">
											Adresse postale<span class="mobile-block"></span> Creative City 9000,<span class="mobile-block"></span> Republic of Design
											<br />
